...
const float brighten_scanlines = 8;
const float brighten_lcd = 4;
...
void main() {
    ...
    sepia.r = dot(tex_color, vec3(.333, .333, .333));
    sepia.g = dot(tex_color, vec3(.333, .333, .333));
    sepia.b = dot(tex_color, vec3(.333, .333, .333));

    sepia *= vec3(1,1,1)*1.3;
