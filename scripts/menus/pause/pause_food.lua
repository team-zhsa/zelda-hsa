...
local item_names_assignable_top = { -- top
	-- Row 1
	"food/fish",												-- Hero shield
	"_placeholder",												-- Hylia shield
	"_placeholder",											-- Mirror shield
	"_placeholder",														-- Bottle
	"_placeholder",																-- Bow / Great bow (3 arrows) / light bow (5 arrows)
	"_placeholder",																-- Bow / Great bow (3 arrows) / light bow (5 arrows)
	"_placeholder",																-- Fire / ice bow
	-- Row 2                                      
	"_placeholder",																-- Lamp      
	"_placeholder",																-- Lamp      
	...
	"_placeholder",												-- Bomb
	"_placeholder",														-- Bottle
	"_placeholder",																-- Bomb bow
	"_placeholder",																-- Fire / ice bow
}

local item_names_assignable_bottom = { -- bottom
	"_placeholder",												-- Hero shield
	"_placeholder",												-- Hero shield
	"_placeholder",												-- Hero shield
	"_placeholder",												-- Hero shield
	"_placeholder",												-- Hero shield
