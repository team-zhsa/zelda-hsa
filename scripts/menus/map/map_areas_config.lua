local map_area_config = { -- Indicates the minimum and maximum coordinates of a given area, then assigns the corresponding name
	...
	[4] = {-- D Row
		...
		{key = "map.out.around_castle"}, -- D4 (Hyrule Field)
	...
	[5] = {-- E Row
		...
		{key = "map.out.around_castle"}, -- E3 (North West Castle)
		{key = "map.out.around_castle"}, -- E4 (Hyrule Field)
	...
	[6] = {-- F Row
		...
		{key = "map.out.around_castle"}, -- F3 (North West Castle)
