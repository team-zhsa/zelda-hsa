...
local function initialise_sidequest_features(game)
  ...
  function parchment_start(quest_name)
    ...
    local timer = sol.timer.start(map, 10, function()
      ...
      local line_1 = sol.language.get_string("quest_status.log.new_quest")
      local line_2 = sol.language.get_string("quest_status.log." .. quest_name)
  ...
  function parchment_end(quest_name)
    ...
    local timer = sol.timer.start(map, 10, function()
      -- Show parchment with dungeon name.
      local line_1 = sol.language.get_string("quest_status.log.quest_completed")
      local line_2 = sol.language.get_string("quest_status.log." .. quest_name)
