...
function phase_1()
	...
	if fresco_index < 7 then
		...
		game:start_dialog("menus..introduction.intro_" .. fresco_index, game:get_player_name(), function()
	...
	sol.timer.start(map, 1000, function()
		...
		sol.timer.start(map, 1000, function()
			...
			agahnim:get_sprite():fade_in(40, function()
				game:start_dialog("menus..introduction.intro_7", game:get_player_name(), function()
...
function phase_5()
	...
	black_surface:fade_out(40, function()
		...
		map:get_camera():dynamic_shake({count = 500, amplitude = 2, speed = 50, entity=world_map}, function()
			game:start_dialog("menus..introduction.intro_8", function()
				black_surface:fade_in(40, function()
					fresco_index = 8
					phase_6()
				end)
