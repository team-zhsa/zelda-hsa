...
switch_5_tile:register_event("on_activated", function()
  switch_5_tile:set_activated(false)
  tile_5_floor_1:set_visible(true)
  tile_5_floor_2:set_visible(true)
  tile_5_floor_3:set_visible(true)
  tile_5_floor_4:set_visible(true)
  tile_5_floor_5:set_visible(true)
  tile_5_floor_6:set_visible(true)
  tile_5_floor_7:set_visible(true)
  tile_5_floor_8:set_visible(true)
  tile_5_floor_9:set_visible(true)
  tile_5_floor_10:set_visible(true)
  timer_manager:start_timer(map, 7000, "countdown", true, true, function()
    tile_5_floor_1:set_visible(false)
    tile_5_floor_2:set_visible(false)
    tile_5_floor_3:set_visible(false)
    tile_5_floor_4:set_visible(false)
    tile_5_floor_5:set_visible(false)
    tile_5_floor_6:set_visible(false)
    tile_5_floor_7:set_visible(false)
    tile_5_floor_8:set_visible(false)
    tile_5_floor_9:set_visible(false)
    tile_5_floor_10:set_visible(false)
  end)
end)
