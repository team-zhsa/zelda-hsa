...
local rewards = {
  {item_name = "piece_of_heart", variant = 1, savegame_variable = "inside_kakarico_chest_game_piece_of_heart"},
...
function npc_minigame:on_interaction()
  ...
  if playing and not won then
    game:start_dialog("maps.houses.kakarico_village.chest_house.minigame_already_playing")
  elseif not playing and won then
    game:start_dialog("maps.houses.kakarico_village.chest_house.minigame_finish")
  else
    game:start_dialog("maps.houses.kakarico_village.chest_house.minigame_welcome", play_question_dialog_finished)
  end
end
