			...
			sword_movement_1:start(sword, function()
				...
				sol.timer.start(map, 100, function()
					...
					sword_movement_2:start(sword, function()
						...
						sword_movement_3:set_max_distance(12)
						...
						sword_movement_3:start(sword, function()
							...
							sword_movement_4:set_speed(8)
							sword_movement_4:set_max_distance(20)
							...
							sword_movement_4:start(sword, function()
								...
								sword_movement_5:set_speed(10)
								sword_movement_5:set_max_distance(24)
								...
								sword_movement_5:start(sword, function()
									...
									sol.timer.start(map, 100, function()
										...
										sword_movement_6:set_speed(24)
										sword_movement_6:set_max_distance(52)
