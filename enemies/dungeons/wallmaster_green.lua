...
function enemy:on_restarted()
  ...
  if hero_sprite_ce ~= nil then
    hero_sprite_ce:remove()
  end
  hero_sprite_ce = nil
  shadow = nil
  grabbed_hero = false
...
function enemy:on_attacking_hero(hero, enemy_sprite)
  ...
  local movement_back = sol.movement.create("straight")
  ...
  -- Teleport the hero with an anmation #254
  ...
  local hero_sprite = hero_sprite_ce:create_sprite("hero/tunic" .. game:get_ability("tunic"))
  hero_sprite:set_animation("hurt")

  sol.timer.start(hero, 500, function()

    movement_hero:set_angle(math.pi / 2)
    movement_hero:set_speed(192)
    movement_hero:set_max_distance(400)
    movement_hero:set_ignore_obstacles(true)
    movement_hero:start(hero_sprite)
    movement_back:set_angle(math.pi / 2)
    movement_back:set_speed(192)
    movement_back:set_max_distance(400)
    movement_back:start(sprite)
    function movement_hero:on_finished()
      movement_back:stop()
