...
function enemy:on_created()
  self:set_life(4000); self:set_damage(56)
  self:create_sprite("enemies/outside/lynel_black")
...
local function go_hero()
  ...
  if rand < 4 then movement:set_speed(80) else movement:set_speed(160) end
