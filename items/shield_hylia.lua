...
-- initialise the item.
item:set_savegame_variable("possession_shield_hylia")
...
function item:on_using()
  ...
  local is_shield_usable = hero_state_object and not hero_state_object:get_can_use_item("shield_hylia")
...
local function initialise_hero_meta()
  ...
  function hero_meta:is_shield_protecting(enemy, enemy_sprite)
    local item = self:get_game():get_item("shield_hylia")
